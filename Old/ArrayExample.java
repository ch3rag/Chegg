public class ArrayExample {
    ...
    private static double[][] extract(double[][] a) {
        ...
        // Loop through each column of a to check if number of negatives is at least
        // halfNumRows
        for (int j = 0; j < nCols; j++) {
            ...
            // If noOfNegativesInCol is at least halfNumRows, set removeCol[i] to
            // true and also update noOfColsRemoved
    ...
    private static double[][] replace(double[][] b) {
        ...
        for (int i = 0; i < b.length; i++) {
            ...
            // Now replace all negative numbers of i-th row of b with the row
            // average
    ...
    public static void main(String[] args) {
        double[][] a = { { -1, 4, 3, 2, -3, 3 }, { -2, 3, 5, -4, 0, 0 }, { -1, -3, -4, 1, -1, 0 },
                { -1, 2, -3, 6, 5, 3 }, { -3, 2, -3, -5, 1, -6 } }; // A 5 x 6 Dimension;
