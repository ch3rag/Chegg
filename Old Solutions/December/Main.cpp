...
int main() {
	...
	cout << "Number Of Odd Values: " << numOdds << endl;

	// Test Part - C
	int sumOfEvens = sumEvenValues(array, 8);
	cout << "Sum Of Even Values: " << sumOfEvens << endl;

	//  Test Part - D
	int arr1[] = {1, 5, 3};
	int arr2[] = {8, 7};
	cout << "All Elements Of Arr1 < Arr2? "
		 << isArr1SmallerThanArr2(arr1, 3, arr2, 2) << endl
		 << "All Elements Of Arr1 < Array? "
		 << isArr1SmallerThanArr2(arr1, 3, array, 8) << endl;
	return 0;
}