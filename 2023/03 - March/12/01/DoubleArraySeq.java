...
public class DoubleArraySeq implements Cloneable {
	 ...
	 * Note that the addAfter and addBefore methods work efficiently (without
	 ...
	 * addAfter and addBefore methods work
	 ...
	 *               The sequence may not be empty.
	 * @postcondition
	 *                The last element in the sequence has been set to the current
	 *                index.
	 *                (but if this sequence has no elements at all, then there is no
	 *                current element).
	 * @exception IllegalStateException
	 ...
	 * @precondition
	 *               'n' must range from 1 to manyItems and the sequence may not be
	 *               empty.
	 * @postcondition
	 *                The nth element of this sequence is now the current element
	 *                and it's value has been returned.
	 *                If this sequence has no elements at all, then there is no
	 *                current element.
	 * @exception IllegalStateException
	 *                                  Indicates that the sequence is empty, or n
	 ...
	 *               The sequence may not be empty.
	 * @postcondition
	 *                The selected element of this sequence is now the current
	 *                element, and what nth number of the sequence that element is
	 *                has been returned.
	 *                If this sequence has no elements at all, then there is no
	 *                current element.
	 *                If the sequence does not contain the element, then the current
	 *                element does not change.
	 * @exception IllegalStateException
	 *                                  Indicates that the sequence is empty, or the
	 ...
	 *                there was a current element,
	 *                then the new element is placed after the current element. If
	 *                there was no current element,
	 *                then the new element is placed at the end of the sequence. In
	 *                all cases, the new element
	 ...
	 *                A new copy of the element has been added to this sequence. If
	 *                there was a current element,
	 *                then the new element is placed before the current element. If
	 *                there was no current element,
	 *                then the new element is placed at the start of the sequence.
	 *                In all cases, the new element
	 *                becomes the new current element of this sequence.
	 * @exception OutOfMemoryError
	 *                             Indicates insufficient memory for increasing the
	 *                             sequence's capacity.
	 ...
	 *                The new element that is being added.
	 * @postcondition
	 *                The new element has been added to the front of this sequence.
	 ...
	 *                The new element that is being added.
	 * @postcondition
	 *                The new element has been added to the end of this sequence.
	 *                The new element becomes the new current element of this
	 *                sequence.
	 * @exception OutOfMemoryError
	 *                             Indicates insufficient memory for increasing the
	 ...
	 *                sequence.
	 *                The current element of this sequence remains where it was, and
	 *                the addend is also unchanged.
	 ...
	 * @return
	 *         A new sequence that has the elements of s1 followed by the elements
	 *         of s2 (with no current element).
	 *         Subsequent changes to the new sequence will not affect the original
	 *         sequences, nor vice versa.
	 * @exception NullPointerException.
	 ...
	 * @postcondition
	 *                The first element in this sequence has been removed.
	 *                If there is a next element, that element is now the current
	 *                element.
	 *                If there was no following element, then there is now no
	 *                current element.
	 * @exception IllegalStateException
	 ...
	 * @param - none
	 * @return
	 *         The return value is an independent copy (clone) of this sequence.
	 ...
	 * @postcondition
	 *                If the sequences being compared are equivalent, then equals
	 ...
	 * second item is the current item, the method should return: <1.1, [2.2], 3.3>.
	 *
	 * @return a String representation of this sequence.
	 */

	public String toString() {
		// StringBuilder To Create A String Containing All The Elements
		// Start With <
		StringBuilder sb = new StringBuilder("<");
		// Loop Through All The Items
		for (int i = 0; i < manyItems; i++) {
			// If There Is Current Element
			if (isCurrent() && getCurrent() == data[i]) {
				sb.append("[" + data[i] + "]");
			} else {
				// For All Elements Except Current
				sb.append(data[i]);
			}
